...
import { deleteProduct, getAdminProducts, getAllCategories, getProductsByAddress, getSingleProduct, getlatestProducts, newProduct, searchAllProducts, updateProduct } from "../controllers/product.js";
